...
public partial class @InputSystem_Actions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""GameOver"",
            ""id"": ""9e30b260-948b-4ca9-953b-ad899cc12a95"",
            ""actions"": [
                {
                    ""name"": ""Restart"",
                    ""type"": ""Button"",
                    ""id"": ""5e7abffe-f4de-471b-a1ab-e7cd782488e3"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""735fd66f-30ab-4dff-9632-8ef5d0c5a8f8"",
                    ""path"": ""<Keyboard>/r"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ~@InputSystem_Actions()
    {
        ...
        UnityEngine.Debug.Assert(!m_GameOver.enabled, "This will cause a leak and performance issues, InputSystem_Actions.GameOver.Disable() has not been called.");
    }
    ...
    public struct GameOverActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public GameOverActions(@InputSystem_Actions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "GameOver/Restart".
        /// </summary>
